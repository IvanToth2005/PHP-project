...
$modifiedPostalCode = $_POST['modifiedPostalCode'];
...
$sql = "UPDATE cities 
        ...
        SET cities.city_name='$modifiedCityName', zipcodes.zip_code='$modifiedPostalCode', counties.county_name='$modifiedCounty' 
